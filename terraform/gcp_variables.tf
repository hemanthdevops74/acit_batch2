...
variable gcp_subnet3_cidr {
  default = "10.240.2.0/24"
}


variable gcp_vm1_address {
  description = "Private IP address for GCP VM instance."
  default = "10.240.0.100"
}

variable gcp_vm2_address {
  description = "Private IP address for GCP VM instance."
  default = "10.240.0.101"
}

variable gcp_vm3_address {
  description = "Private IP address for GCP VM instance."
  default = "10.240.1.100"
}

variable gcp_vm4_address {
  description = "Private IP address for GCP VM instance."
  default = "10.240.2.100"
}
